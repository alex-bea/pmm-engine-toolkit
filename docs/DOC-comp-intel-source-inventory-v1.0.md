...
| `skills/comp-intel/examples/EX-synthetic.md` | Fictional walkthrough; public baseline | Synthetic | Same path | `rewrite-generic` | Same path plus `examples/fictional-devtools/` and controller fixtures | Expand the safe example into an end-to-end case; never replace it with real entities. | CI-CFG-003, CI-PRV-002, CI-QA-001 | Synthetic acceptance test |
