...
another compatible agent environment and use only the sources you authorize. First-time setup,
readiness verification, diagnosis, and repair use the conditional
[setup contract](skills/comp-intel/references/REF-comp-intel-setup-contract.md); ready recurring
runs use the sole [normal workflow](skills/comp-intel/references/RUN-workflow.md).
